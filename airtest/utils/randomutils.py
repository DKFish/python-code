...
class FourEl:
    ...
    def get_distritCode(self):
        codelist = []
        # 读取地区码
        file = open('/Users/finup/Desktop/work/dev/bestriveruitest/resource/districtcode.txt',
                    encoding='ISO-8859-1')
    ...
    def create_bankAccount(self):
        # PREFIX = ["622202", "621226", "621226", "622258", "622110"]
        PREFIX = ["622202"]
        # 随机生成银行卡
        prefix = PREFIX[random.randint(0, len(PREFIX) - 1)]
...
if __name__ == '__main__':
    four_el: FourEl = FourEl()
    for i in range(0, 200):
        b = four_el.create_name()
        c = four_el.create_phone()
        d = four_el.create_idcard()
        e = four_el.create_bankAccount()
        print("姓名：{}".format(b))
        print("手机号：{}".format(c))
        print("身份证号：{}".format(d))
        print("银行卡号：{}".format(e))
